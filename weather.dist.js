...
exports.getTimeZone = exports.getOWM = exports.getParamString = undefined;

var _constants = __webpack_require__(277);

var getParamString = exports.getParamString = function getParamString() {
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return Object.entries(args).reduce(function (str, param) {
    return str + '&' + param[0] + '=' + param[1];
  }, '');
};

var getOWMURL = function getOWMURL(apiKey) {
  return function (url) {
    return function (endpoint) {
      return function (params) {
        return function (city) {
          return '' + url + (endpoint + '?q=' + city + '&appid=' + apiKey + '&') + getParamString(params);
        };
      };
    };
  };
...
var getTimeZoneURL = function getTimeZoneURL(apiKey) {
  return function (url) {
    return function (lat, long) {
      return function (timestamp) {
        return '' + url + lat + ',' + long + '&timestamp=' + timestamp + '&key=' + apiKey;
      };
    };
  };
};

var getOWM = exports.getOWM = getOWMURL(_constants.APIKEY)('https://api.openweathermap.org/data/2.5/');
var getTimeZone = exports.getTimeZone = getTimeZoneURL(_constants.GAPIKEY)('https://maps.googleapis.com/maps/api/timezone/json?location=');
...
var searchCity = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var textField, city, cityData;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        textField = document.querySelector('.js-city-field');
                        city = textField.value;

                        textField.value = '';
                        _context.next = 5;
                        return (0, _city.fetchCityData)(city);

                    case 5:
                        cityData = _context.sent;

                        (0, _city2.renderCity)(cityData);
    ...
    return function searchCity() {
        return _ref.apply(this, arguments);
    };
}();

var _city = __webpack_require__(279);

var _city2 = __webpack_require__(278);
...
var APIKEY = exports.APIKEY = '03cea7a18f7eab5746b2540b441e5feb';
var GAPIKEY = exports.GAPIKEY = 'AIzaSyD5pkDk2bElphluD-UfyTTMMxoSbsYs1-c';
...
var _parser = __webpack_require__(282);
...
var renderCity = exports.renderCity = function renderCity(_ref) {
    ...
    var todayData = (0, _parser.getTodaysTemplate)(today, timeZone);
    var firstPage = 0;
    var numOfPages = 5;
    ...
    var forecastTemplate = (0, _parser.getForecastTable)(forecast, timeZone);
...
exports.fetchCityData = undefined;

//compose these functions??
var fetchCityData = exports.fetchCityData = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(city) {
    var _ref2, today, forecast, timestamp, _today$coord, lat, lon, timeZone;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _weather.fetchWeather)(city);
          ...
          case 2:
            ...
            timestamp = today.dt;
            _today$coord = today.coord, lat = _today$coord.lat, lon = _today$coord.lon;
            _context.next = 9;
            return (0, _timezone.fetchTimeZone)(timestamp, lat, lon);
  ...
  return function fetchCityData(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _weather = __webpack_require__(281);

var _timezone = __webpack_require__(280);
...
exports.fetchTimeZone = undefined;

var _axios = __webpack_require__(93);

var _axios2 = _interopRequireDefault(_axios);

var _endpoints = __webpack_require__(99);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

var fetchTimeZone = exports.fetchTimeZone = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(timestamp, lat, lon) {
        var response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return _axios2.default.get((0, _endpoints.getTimeZone)(lat, lon)(timestamp));
    ...
    return function fetchTimeZone(_x, _x2, _x3) {
        return _ref.apply(this, arguments);
    };
}();
...
var todaysWeatherURL = (0, _endpoints.getOWM)('weather')({ units: 'metric' });
var forecastURL = (0, _endpoints.getOWM)('forecast')({ units: 'metric', cnt: 16 });

var requestTodaysWeather = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(city) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', _axios2.default.get(todaysWeatherURL(city)));
  ...
  return function requestTodaysWeather(_x) {
    return _ref.apply(this, arguments);
  };
}();

var requestWeatherForecast = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(city) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', _axios2.default.get(forecastURL(city)));
  ...
  return function requestWeatherForecast(_x2) {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return Promise.all([requestTodaysWeather(city), requestWeatherForecast(city)]);
          ...
          case 2:
            ...
            today = _ref5[0];
            forecast = _ref5[1];
            return _context3.abrupt('return', { today: today.data, forecast: forecast.data });
...
var _momentTimezone = __webpack_require__(486);

var _momentTimezone2 = _interopRequireDefault(_momentTimezone);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var getCity = exports.getCity = function getCity(response) {
    return response.name;
};

var getCountry = exports.getCountry = function getCountry(response) {
    return response.sys.country;
};

var getWeatherData = exports.getWeatherData = function getWeatherData(response) {
    return response.weather[0].main + ' (' + response.weather[0].description + ')';
};

var getTodaysTemperatures = exports.getTodaysTemperatures = function getTodaysTemperatures(response) {
    return 'Temperature (min, average, max): ' + (response.main.temp_min + ', ' + response.main.temp + ', ' + response.main.temp_max);
};

var getSunriseSunset = exports.getSunriseSunset = function getSunriseSunset(weatherResponse, timezoneResponse) {
    var timeZoneId = timezoneResponse.timeZoneId;
    var _weatherResponse$sys = weatherResponse.sys,
        sunrise = _weatherResponse$sys.sunrise,
        sunset = _weatherResponse$sys.sunset;

    var sunriseTs = parseInt(sunrise, 10) * 1000;
    var sunsetTs = parseInt(sunset, 10) * 1000;
    var sunriseHhMm = _momentTimezone2.default.tz(sunriseTs, timeZoneId).format('HH:mm');
    var sunsetHhMm = _momentTimezone2.default.tz(sunsetTs, timeZoneId).format('HH:mm');
    return 'Sunrise: ' + sunriseHhMm + ', Sunset: ' + sunsetHhMm;
};

var getTodaysTemplate = exports.getTodaysTemplate = function getTodaysTemplate(weather, timezone) {
...
var getForecastRow = exports.getForecastRow = function getForecastRow(weather, timezone) {
    return function (rowNumber) {
        var row = weather.list[rowNumber];
        var date = _momentTimezone2.default.tz(row.dt * 1000, timezone.timeZoneId).format('MMM Do');
...
var getForecastTable = exports.getForecastTable = function getForecastTable(weather, timezone) {
    return function (firstRow, lastRow) {
        var rowTemplate = getForecastRow(weather, timezone);
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(289)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(287));
...
var moment = module.exports = __webpack_require__(487);
moment.tz.load(__webpack_require__(485));
